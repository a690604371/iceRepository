...
public class AspectExample {
    ...
    private static final Logger log = LoggerFactory.getLogger(AspectExample.class);
    /**
     * [@Pointcut]：统一切点,对com.example.controller及其子包中所有的类的所有方法切面
     * ps: @Pointcut("execution(public * com.example.controller..*.*(..))")
     */
    @Pointcut("execution(public * com.haitai.ice.abortAspect.controller.AspectExampleController.*(..))")
