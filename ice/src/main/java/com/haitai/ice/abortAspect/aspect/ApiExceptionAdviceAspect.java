...
public class ApiExceptionAdviceAspect {
    ...
    private static final Logger log = LoggerFactory.getLogger(ApiExceptionAdviceAspect.class);
    /**
     * 匹配所有使用以下注解的方法
     *
     * @see ApiAnnotation
     */
    @Pointcut("@annotation(com.haitai.ice.abortAspect.annotation.ApiAnnotation)")
